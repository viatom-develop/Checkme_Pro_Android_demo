...
void adpcm_coder(short *indata, char *outdata, int len, int inc,adpcm_state *state)
{
...
void adpcm_decoder(char *indata, short *outdata, int len, int inc,adpcm_state *state)
{
