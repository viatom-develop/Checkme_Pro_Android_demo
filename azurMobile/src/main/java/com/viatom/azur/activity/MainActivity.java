...
import com.viatom.azur.bluetooth.BleUtils;
import com.viatom.azur.bluetooth.ParaSyncThreadListener;
import com.viatom.azur.monitor.ui.MonitorActivity;
...
import com.viatom.update.*;

import org.json.JSONException;
import org.json.JSONObject;
import org.w3c.dom.Text;

public class MainActivity extends com.viatom.update.BaseActivity implements OnCancelListener
...
//                prepareSearchBT(1000);
        ...
        } else if(requestCode == com.viatom.azur.monitor.element.Constant.REQUEST_COME_INTO_MONITOR) {
            finish();
        }
    }
...
//        airTraceStatus = true;
        ...
        com.viatom.azur.monitor.element.Constant.initDir();
        com.viatom.azur.monitor.element.Constant.init(MainActivity.this);
        ...
        startActivityForResult(intent, com.viatom.azur.monitor.element.Constant.REQUEST_COME_INTO_MONITOR);
    }
    ...
    public void onDestroy() {
        ...
        com.viatom.azur.monitor.element.Constant.destroyVariable();
        //关闭蓝牙服务
        if (Constant.btConnectFlag) {
